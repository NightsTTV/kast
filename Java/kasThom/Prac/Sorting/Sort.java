...
public final class Sort
{
    ...
    private static void checkSort( Integer [ ] a )
    {
        ...
        // Fisher–Yates shuffle using java.util.Random
    private static <AnyType> void shuffle(AnyType[] a) {
        Random rng = new Random();
        for (int i = a.length - 1; i > 0; i--) {
            int j = rng.nextInt(i + 1);  // random int from 0..i
            AnyType tmp = a[i];
            a[i] = a[j];
            a[j] = tmp;
        }
        ...
        System.out.println("N,order,time_ms");
        ...
        for (int n : sizes) {
            ...
            System.out.println(n + ",sorted," + ms);
            ...
            ms = (end - start) / 1_000_000;
            System.out.println(n + ",reverse," + ms);
            ...
            ms = (end - start) / 1_000_000;
            System.out.println(n + ",random," + ms);
        }
    }
}
