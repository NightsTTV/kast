	...
	public static void main (String[] args)
	{
		...
		try
		{
			...
			while (true) {
				...
				System.out.println("Event read from file: " + event);//Print contents of each event
		...
		System.out.println("Event list before reading file: " + eventList);//Print its contents to show it is null
		...
		try {
			...
			System.out.println("Event list after reading from file: " + eventList);
